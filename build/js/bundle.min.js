function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsiva)}function navegacionResponsiva(){document.querySelector(".navegacion").classList.toggle("mostrar")}
